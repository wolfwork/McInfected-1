 ...
 * -------------------------
 * 
 * void checkForUpdates(Plugin plugin, int id) {
 * 
 * Updater updater = new Updater(plugin, id, plugin.getFile(), Updater.UpdateType.NO_DOWNLOAD, true);
 * 
...
public class Updater {
	...
	public boolean hasUpdate() {
		waitForThread();
		return this.result == Updater.UpdateResult.UPDATE_AVAILABLE;
	}
